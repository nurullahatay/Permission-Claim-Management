...
public class PersonelDAO extends DatabaseHelper {
	...
	public void addPersonel(Personel personel) throws Exception {
		logger.debug("PersonelDAO addPersonel metodu �al��maya ba�lad�.");
		...
		try {
			...
			logger.debug("PersonelDAO addPersonel metodu �al��mas� bitti.");
		}
	}

	private void addPersonelRoles(Personel personel) throws Exception {
		logger.debug("PersonelDAO addPersonelRoles metodu �al��maya ba�lad�.");
		...
		try {
			...
			closeConnection(conn);
			logger.debug("PersonelDAO addPersonelRoles metodu �al��mas� bitti.");
		}
	}

	public Personel getPersonel(long sicilNo) throws Exception {
		logger.debug("PersonelDAO getPersonel metodu �al��maya ba�lad�.");
		...
		try {
			...
			closeConnection(conn);
			logger.debug("PersonelDAO getPersonel metodu �al��mas� bitti.");
		}
		return personel;
	}

	public ArrayList<Personel> getAllPersonel() throws Exception {
		logger.debug("PersonelDAO getAllPersonel metodu �al��maya ba�lad�.");
		Connection conn = null;
		ResultSet rs = null;
		...
		try {
			...
			closeConnection(conn);
			logger.debug("PersonelDAO getAllPersonel metodu �al��mas� bitti.");
		}
		return personels;
	}

	public void updatePersonel(Personel personel) throws Exception {
		logger.debug("PersonelDAO updatePersonel metodu �al��maya ba�lad�.");
		Connection conn = (Connection) getConnection();
		PreparedStatement stmt = null;
		StringBuilder query = new StringBuilder();
		try {
			...
			closePreparedStatement(stmt);
			closeConnection(conn);
			logger.debug("PersonelDAO updatePersonel metodu �al��mas� bitti.");
		}
	}

	public void deletePersonel(long sicilno) throws Exception {
		logger.debug("PersonelDAO deletePersonel metodu �al��maya ba�lad�.");
		Connection conn = null;
		...
		try {
			...
			closeConnection(conn);
			logger.debug("PersonelDAO deletePersonel metodu �al��mas� bitti.");
		}
	}
